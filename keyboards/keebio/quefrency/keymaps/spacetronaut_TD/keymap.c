...
qk_tap_dance_action_t tap_dance_actions[] = {
  [TD_WTAB] = ACTION_TAP_DANCE_DOUBLE(KC_SPC, _WINTAB)
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    ...
    KC_F9,   KC_F10,  KC_LCTL, KC_LALT, KC_LGUI, MO(_FN1),TD(TD_WTAB),      KC_SPC, _______,  _______, KC_RCTL, KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT
  ),
